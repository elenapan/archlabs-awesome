...
-- local start_screen_box = wibox.container.background()
-- start_screen_box.bg = start_screen.bg
-- start_screen_box.shape = gears.shape.rounded_rect
-- start_screen_box.shape_border_radius = 20
...
-- TODO make these normal paths
local bookmarks = wibox.widget {
    create_bookmark("HOME", ""),
    pad(1),
    create_bookmark("DOWNLOADS", "~/dwn"),
    pad(1),
    create_bookmark("MUSIC", "~/mus"),
    pad(1),
    create_bookmark("PICTURES", "~/pix"),
    pad(1),
    create_bookmark("WALLPAPERS", "~/pix/wps"),
    layout = wibox.layout.fixed.vertical
}
...
-- local petal_container_top_left = create_launcher_petal(beautiful.xbackground)
-- local petal_container_top_right = wibox.widget {
--     create_launcher_petal(beautiful.xbackground),
...
--                 awful.button({ }, 1, function ()
--                     awful.spawn(browser .. " reddit.com")
--                 end)
-- ))
...
-- helpers.add_clickable_effect(petal_top_left)
-- helpers.add_clickable_effect(petal_top_right)
-- helpers.add_clickable_effect(petal_bottom_left)
-- helpers.add_clickable_effect(petal_bottom_right)
